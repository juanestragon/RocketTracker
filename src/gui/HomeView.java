...
public class HomeView {
    ...
    private String getHumanArenaName(String arenaName) {
        ...
        return switch (arenaName) {
            ...
            case "Woods_P", "Woods_Night_P" -> "Drift Woods";
            ...
            case "UtopiaStadium_P", "UtopiaStadium_Dusk_P", "UtopiaStadium_Lux_P",
            ...
            case "Wasteland_P" -> "Badlands";

            case "Wasteland_Night_P" -> "Badlands";

            case "Labs_Holyfield_Space_P" -> "Force Field";
            ...
            case "Labs_Galleon_P" -> "Galleon";

            case "Labs_Galleon_Mast_P" -> "Galleon Retro";
            ...
            // Hoops Maps
            case "HoopsStreet_P" -> "The Block";

            case "Hoops_P" -> "Dunk House";
            ...
            // 4V4 Maps
            case "Labs_4v4_Arena15_EuroStadium_Night_P" -> "Mannfield";
